...
const myTickets = [
  { id: "TKT-8942-A", event: "Nairobi Tech Week 2024", package: "VIP Access", date: "Oct 12, 2024" },
  { id: "TKT-1249-B", event: "Sol Fest", package: "Regular", date: "Nov 05, 2024" },
                ...
                tickets.filter(t => t.status === 'ACTIVE' || t.status === 'SUCCESS').map((ticket, idx) => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <span className="text-sm font-medium text-gray-500 bg-gray-50 px-2 py-1 rounded-md">{ticket.id.split('-')[0].toUpperCase()}</span>
                    </div>
                    <h3 className="text-lg font-bold text-gray-900 mb-1">{ticket.event_title}</h3>
                    <p className="text-gray-500 text-sm mb-4">{new Date(ticket.event_date || Date.now()).toDateString()} • {ticket.package_name}</p>
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/40 backdrop-blur-sm">
            ...
            >
              ...
              <div className="p-8 text-center border-b border-gray-100">
                <h3 className="text-2xl font-bold text-gray-900 mb-1">{selectedTicket.event}</h3>
                <p className="text-blue-600 font-medium">{selectedTicket.package}</p>
              </div>
